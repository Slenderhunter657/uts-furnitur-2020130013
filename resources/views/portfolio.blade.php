...
@section('title', 'Portofolio') @section('content') <h1 class="cover-heading">Our Portofolio!</h1>
<div id="demo" class="carousel slide" data-ride="carousel"> {{-- Indikator carousel --}}
